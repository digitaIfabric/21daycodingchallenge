...
const getVolume = function (solid: any): number {
    switch(solid.type){
...
const totalVolume = function (solids: any): number {
  return solids.reduce((volume: number, solid: any) => volume + getVolume(solid), 0)
}
