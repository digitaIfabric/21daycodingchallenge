...
const festivalColours = (color1: number): number[] => {
  let saturation: number = ((color1 + 150) > 360 ) ? color1 - 210 : color1 + 150;
  let lightness: number = ((color1 + 210) > 360 ) ? color1 - 150 : color1 + 210;
  console.log([saturation, lightness].sort());
